    ...
    <div className="sticky lg:static top-0 navbar bg-base-100 min-h-0 flex-shrink-0 justify-between z-20 shadow-md shadow-secondary">
      <div className="navbar-start w-auto lg:w-1/2">
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6">
          <div className="flex relative w-10 h-10">{/* Add logo */}</div>
          <div className="flex flex-col">
            <span className="font-bold leading-tight">Allo-Protocol</span>
            <span className="text-xs">Smart Contract Client</span>
          </div>
        </Link>
